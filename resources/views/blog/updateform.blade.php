    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{route('blogguncelle',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Başlık:</label>
                                            <input  required name="title" type="text" value="{{$data->title}}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="col">
                                            <img width="80" height="80" src="{{ asset("/storage/uploads/".$data->img_url) }}" alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>İçerik:</label>
                                            <textarea class="form-control" name="text"  id="" cols="30" rows="3" placeholder="Blog content">{{$data->content}}</textarea>
                                        </div>
                                    </div>
                                </div>
